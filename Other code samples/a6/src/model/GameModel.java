...
public class GameModel {
    ...
    // TODO 4 done ish but underconstrained: Add a field to keep track of the Direction associated with the most recent player
     ...
     **************************************************************** */
    /**
     * return the Direction associated with the most recent player input.
     */
    public Direction playerCommand(){return mostRecentDirection;}
    /* ****************************************************************
     * Mutator methods                                               *
     **************************************************************** */
    /**
     * update the Direction associated with the most recent player input.
     */
    public void updatePlayerCommand(Direction direction){this.mostRecentDirection = direction;}
    ...
    public GameModel(GameMap map, Randomness randomness, boolean withAI) {
        ...
        // Uncomment this line after completing TODO 6 done
    ...
    public void processPacMannArrival() {
        ...
        // TODO 3 done but unchecked: Update the model based on PacMann's arrival at vertex `v`. If there is an item
