...
public class GameFrame extends JFrame implements PropertyChangeListener {
    ...
    private void showWinMessage() {
        ...
        JOptionPane.showMessageDialog(this,
                "<- Look at the java guy he's happy about it \n your final score was: " + model.score(),
                "You Won",
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        ...
        //  this code.
        if (Objects.equals(evt.getPropertyName(), "game_result")){
            GameState value = (GameState) evt.getNewValue();
            if (value == GameState.VICTORY){ showWinMessage();}
            if (value == GameState.DEFEAT){ showLoseMessage();}
        }
    }
}
